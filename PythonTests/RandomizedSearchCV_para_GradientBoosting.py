...
log_dir = "logs/gradient_boosting/" + time.strftime("%Y%m%d-%H%M%S")
...
random_search = RandomizedSearchCV(estimator=model, param_distributions=param_dist, n_iter=10, cv=3, random_state=42, n_jobs=-1, verbose=2)
...
plt.savefig("shap_summary_plot_gradient_boosting.png")  # Guardar el gráfico resumen
...
plt.savefig("shap_dependence_plot_V14_gradient_boosting.png")  # Guardar el gráfico de dependencia
