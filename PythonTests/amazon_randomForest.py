...
shap.summary_plot(shap_values, X_test, show=False)  # show=False evita que el gráfico se muestre directamente
plt.savefig("shap_summary_plot.png")  # Guardar el gráfico como una imagen

# Gráfico de dependencia SHAP para una característica específica
shap.dependence_plot("V14", shap_values, X_test, show=False)  # show=False evita que el gráfico se muestre directamente
plt.savefig("shap_dependence_plot_V14.png")  # Guardar el gráfico de dependencia como una imagen
